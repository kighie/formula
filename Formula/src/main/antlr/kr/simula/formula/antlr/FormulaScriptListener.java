...
public interface FormulaScriptListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterParamDef(FormulaScriptParser.ParamDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#paramDef}.
	 * @param ctx the parse tree
	 */
	void exitParamDef(FormulaScriptParser.ParamDefContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FormulaScriptParser#typeDecl}.
	 * @param ctx the parse tree
	 */
	void enterTypeDecl(FormulaScriptParser.TypeDeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#typeDecl}.
	 * @param ctx the parse tree
	 */
	void exitTypeDecl(FormulaScriptParser.TypeDeclContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLambdaDecl(FormulaScriptParser.LambdaDeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#lambdaDecl}.
	 * @param ctx the parse tree
	 */
	void exitLambdaDecl(FormulaScriptParser.LambdaDeclContext ctx);
	/**
	 * Enter a parse tree produced by {@link FormulaScriptParser#proto}.
	 * @param ctx the parse tree
	 */
	void enterProto(FormulaScriptParser.ProtoContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#proto}.
	 * @param ctx the parse tree
	 */
	void exitProto(FormulaScriptParser.ProtoContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLambdaArg(FormulaScriptParser.LambdaArgContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#lambdaArg}.
	 * @param ctx the parse tree
	 */
	void exitLambdaArg(FormulaScriptParser.LambdaArgContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterIterableTerm(FormulaScriptParser.IterableTermContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaScriptParser#iterableTerm}.
	 * @param ctx the parse tree
	 */
	void exitIterableTerm(FormulaScriptParser.IterableTermContext ctx);
	/**
