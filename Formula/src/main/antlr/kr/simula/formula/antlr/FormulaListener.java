...
public interface FormulaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FormulaParser#type}.
	 * @param ctx the parse tree
	 */
	void enterType(@NotNull FormulaParser.TypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaParser#type}.
	 * @param ctx the parse tree
	 */
	void exitType(@NotNull FormulaParser.TypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FormulaParser#record}.
	 * @param ctx the parse tree
	 */
	void enterRecord(@NotNull FormulaParser.RecordContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaParser#record}.
	 * @param ctx the parse tree
	 */
	void exitRecord(@NotNull FormulaParser.RecordContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLambdaArg(@NotNull FormulaParser.LambdaArgContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaParser#lambdaArg}.
	 * @param ctx the parse tree
	 */
	void exitLambdaArg(@NotNull FormulaParser.LambdaArgContext ctx);
	/**
